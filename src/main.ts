...
// 加载插件时触发
function onLoad() {
    ipcMain.handle('LiteLoader.markdown_it.log', (e: any, consoleMode: any, ...args: any[]) => {
        loggerWriter(consoleMode, ...args);
    });
    ipcMain.handle('LiteLoader.markdown_it.get_log_path', (e: any) => LogPathHelper.getLogFolderPath());
}
